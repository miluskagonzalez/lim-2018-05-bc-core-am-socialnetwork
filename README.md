...
+ Formulario de resgistro e ingreso.
+ Perfil del usuario.
+ Posts para compartir lo que se está pensando, sintiendo, alguna infomacion que se sepa y se quiera compartir con los demás.
+ Muro con time-line para que el usuario pueda ver por orden de publicacion los posts.
+ Likes para poder expresar si estas de acuerdo con algo o te gusta.
+ Mensajes privados.
+ Comunidad o grupos para usuarios que tengan los mismos gustos e intereses.
+ Seguir, para estar informados de los posts de otros usuarios.
...
A través de los formularios enviados a posibles usuarios, entrevistas, testeos del producto, benchmark de otras redes sociales que usan los usuarios, descubrimos que los usuarios sienten la necesidad de compartir en comunidad sus experencias, conocimientos, tips, o cualquier otro tipo de informacion de su interes, muchas veces dijeron que quisieran hacerlo de forma anónima, por lo cual en está red social pueden registrarse con un nickname, por medio de las herramientas ya mensionadas descubrimos que los usuarios desan tener la opcion de mandar mensajes privados, poder seguir a otros usuarios y unirse a otras comunidades.

## ¿Qué problema resuelve el producto para estos usuarios?

UNID∞S permite que el usuario pueda estar en una comunidad de salud donde sólo se toca ese tema, ya sea que el usuario tenga una enfermedad o cuente con alguien en su entorno que la tenga, el podrá contar con la red social UNID∞S para expresarse, recibir informacion o brindarla, resolviendo de este modo el problema de encontrar una comunidad donde solo se habla y comparte información sobre salud.

## Objetivos de los usuarios

El principal objetivo para las personas afectadas por alguna enfermedad y con similares intereses es reunirse por medio de esta comunidad virtual y entre ellos encuentren comprensión y apoyo. Los usuarios de esta red se podran dar diferentes tipos de ayuda mutua, entre consejos, tips, informacion sobre campañas de salud, etc. Los usuarios a través de UNID∞S tienen oportunidad de discutir los motivos, preocupaciones, conocimientos, contrariedades, etc.
...
## ¿Cómo verificasmos que el producto está resolviendo los problemas a los usuarios?

A través de los testeos con el html y los prototipos de baja fidelidad descubrimos que para los usuarios era necesario contar con un perfil anónimo, poder dar like, etc, de este modo pudimos verificar que cumplía con resolver las necesidades del usuario y por lo tanto resolvía sus problemas.

## ¿Cómo nos aseguramos que los usuarios usen el produto?

Para asegurarnos que los usuarios usen el producto, recibimos el feedback que nos dieron y los incluimos en el producto final, logrando así una interfaz minimalista y amigable para el usuario, en la que estos puedan publicar de forma privada si así lo desean y también usando nicknames para protoger su privacidad.
